...
<div class="text-white px-6 py-14 text-center">
    ...
    <form action="{{ route('reservation.store') }}" method="POST" autocomplete="off" class="flex items-center max-w-3xl mx-auto bg-white rounded-full shadow-xl px-4 py-2">
        @csrf
...
<script src="{{ asset('js/liste_reservation.js') }}"></script>